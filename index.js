...
const prefix = '.';
let isPublic = true;
const ownerNumber = '2349038158275@s.whatsapp.net'; // change to your WhatsApp ID
...
async function startBot() {
    ...
    sock.ev.on('messages.upsert', async ({ messages }) => {
        ...
        if (!msg.message || msg.key.fromMe) return; // ignore messages from bot itself
        ...
        // Block commands if bot is in private mode and user isn't owner
